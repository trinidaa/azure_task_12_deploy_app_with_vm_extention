...
$location = "uksouth"
$resourceGroupName = "mate-azure-task-122"
...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://github.com/trinidaa/azure_task_12_deploy_app_with_vm_extention/blob/main/install-app.sh'); commandToExecute = './install-app.sh'}
}
